    ...
    render() {
        ...
        return (
           <tr>
				...
				<td className="col-md-2 col-xs-2 col-sm-2 col-lg-2">{ data.type } { data.prof }</td>
				<td className="col-md-1 col-xs-1 col-sm-1 col-lg-1"><button className="btn btn-Green1 z-depth-2 add" type="button" onClick={ ()=>checkTimeClick(data) }>ADD</button></td>
